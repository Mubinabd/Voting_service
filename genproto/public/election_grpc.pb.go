...
const (
	...
	ElectionService_Get_FullMethodName    = "/protos.ElectionService/Get"
...
type ElectionServiceClient interface {
	...
	Get(ctx context.Context, in *GetByIdReq, opts ...grpc.CallOption) (*ElectionRes, error)
...
func (c *electionServiceClient) Get(ctx context.Context, in *GetByIdReq, opts ...grpc.CallOption) (*ElectionRes, error) {
	out := new(ElectionRes)
	err := c.cc.Invoke(ctx, ElectionService_Get_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ElectionServiceServer interface {
	...
	Get(context.Context, *GetByIdReq) (*ElectionRes, error)
...
func (UnimplementedElectionServiceServer) Get(context.Context, *GetByIdReq) (*ElectionRes, error) {
...
func _ElectionService_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ElectionService_Get_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ElectionServiceServer).Get(ctx, req.(*GetByIdReq))
	}
	return interceptor(ctx, in, info, handler)
}
