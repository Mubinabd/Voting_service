...
type GetAllPartysRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetAllPartysRequest) Reset() {
	*x = GetAllPartysRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetAllPartysRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetAllPartysRequest) ProtoMessage() {}

func (x *GetAllPartysRequest) ProtoReflect() protoreflect.Message {
	mi := &file_party_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetAllPartysRequest.ProtoReflect.Descriptor instead.
func (*GetAllPartysRequest) Descriptor() ([]byte, []int) {
	return file_party_proto_rawDescGZIP(), []int{4}
}

func (x *GetAllPartysRequest) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *GetAllPartysRequest) GetOpenedDate() string {
	if x != nil {
		return x.OpenedDate
	}
	return ""
...
func (x *GetAllPartysRequest) GetFilter() *Filter {
	if x != nil {
		return x.Filter
	}
	return nil
...
var file_party_proto_rawDesc = []byte{
	...
	0x6e, 0x22, 0x72, 0x0a, 0x13, 0x47, 0x65, 0x74, 0x41, 0x6c, 0x6c, 0x50, 0x61, 0x72, 0x74, 0x79,
	...
	,
...
var file_party_proto_goTypes = []interface{}{
	...
	(*GetAllPartysRequest)(nil),  // 4: protos.GetAllPartysRequest
	(*GetAllPartysResponse)(nil), // 5: protos.GetAllPartysResponse
	(*Filter)(nil),               // 6: protos.Filter
	(*GetByIdReq)(nil),           // 7: protos.GetByIdReq
	(*Void)(nil),                 // 8: protos.Void
}
var file_party_proto_depIdxs = []int32{
	6, // 0: protos.GetAllPartysRequest.filter:type_name -> protos.Filter
	2, // 1: protos.GetAllPartysResponse.party:type_name -> protos.PartyRes
	1, // 2: protos.PartyService.CreateParty:input_type -> protos.PartyCreate
	7, // 3: protos.PartyService.GetParty:input_type -> protos.GetByIdReq
	4, // 4: protos.PartyService.GetAllParty:input_type -> protos.GetAllPartysRequest
	3, // 5: protos.PartyService.UpdateParty:input_type -> protos.PartyUpdate
	7, // 6: protos.PartyService.DeleteParty:input_type -> protos.GetByIdReq
	8, // 7: protos.PartyService.CreateParty:output_type -> protos.Void
	2, // 8: protos.PartyService.GetParty:output_type -> protos.PartyRes
	5, // 9: protos.PartyService.GetAllParty:output_type -> protos.GetAllPartysResponse
	8, // 10: protos.PartyService.UpdateParty:output_type -> protos.Void
	8, // 11: protos.PartyService.DeleteParty:output_type -> protos.Void
...
func file_party_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_party_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetAllPartysRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
